        ...
        <div class="flex flex-col h-full w-64">
            ...
            <div class="overflow-y-auto flex-1 py-4">
                <nav class="px-2 space-y-1">
                    <!-- Dashboard Link -->
                    <a href="#" class="nav-item {{ request()->is('dashboard*') ? 'active' : '' }}">
                    ...
                    <a href="#" class="nav-item {{ request()->is('students*') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <!-- Reports Link -->
                    <a href="{{ route('reports.behavior') }}" class="nav-item {{ request()->is('reports/behavior*') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
