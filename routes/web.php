...
Route::get('/behavior/deduct', function () {
    return view('behavior.deduct'); // หน้านี้ extend จาก layouts.app
});

// Report routes
Route::get('/reports/behavior', [ReportController::class, 'index'])->name('reports.behavior');
