                ...
                <div class="d-flex justify-content-between" style="height: 64px;">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="fs-5 fw-bold text-white d-flex align-items-center">
                            ...
                            <!-- ชื่อเต็มสำหรับหน้าจอขนาดกลางขึ้นไป -->
                            <span class="d-none d-md-inline">ระบบสารสนเทศจัดการคะแนนวินัยโรงเรียนนวมินทราชูทิศมัชฌิ</span>
                            
                            <!-- ชื่อย่อสำหรับหน้าจอขนาดเล็ก -->
                            <span class="d-inline d-md-none">ระบบวินัยนักเรียน</span>
                        </div>
                    </div>
